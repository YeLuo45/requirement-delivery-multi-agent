...
const AUDIT_LOG = {
  'PRJ-20260615-001': [
    {
      id: 'au-001',
      proposalId: 'P-20260615-001',
      actor: 'system',
      action: 'proposal.create',
      at: '2026-06-15T09:12:00Z',
      detail: { title: 'JSON to CSV CLI', status: 'research_direction_pending' },
    },
    {
      id: 'au-002',
      proposalId: 'P-20260615-001',
      actor: 'market_research',
      action: 'stage.transition',
      at: '2026-06-15T09:12:05Z',
      detail: {
        from: 'research_direction_pending',
        to: 'research',
        reason: 'Research direction approved',
      },
    },
    {
      id: 'au-003',
      ...
      actor: 'market_research',
      action: 'handoff.emit',
      at: '2026-06-15T09:12:08Z',
      detail: { to: 'coordinator', reason: 'Research complete' },
    },
    {
      id: 'au-004',
      proposalId: 'P-20260615-001',
      actor: 'coordinator',
      action: 'handoff.emit',
      at: '2026-06-15T09:12:20Z',
      detail: { to: 'pm', reason: 'Captured intent; routing to PM' },
    },
    {
      id: 'au-005',
      proposalId: 'P-20260615-001',
      actor: 'pm',
      action: 'stage.transition',
      at: '2026-06-15T09:12:30Z',
      detail: { from: 'clarifying', to: 'prd_pending_confirmation', reason: 'PRD drafted' },
    },
    {
      id: 'au-006',
      proposalId: 'P-20260615-001',
      actor: 'pm',
      action: 'stage.transition',
      at: '2026-06-15T09:12:50Z',
      detail: {
        from: 'prd_pending_confirmation',
        to: 'approved_for_dev',
        reason: 'PRD auto-approved',
      },
    },
    {
      id: 'au-007',
      ...
      actor: 'pm',
      action: 'handoff.emit',
      at: '2026-06-15T09:13:00Z',
      detail: { to: 'dev', reason: 'PRD approved; handing off' },
    },
    {
      id: 'au-008',
      proposalId: 'P-20260615-001',
      actor: 'dev',
      action: 'stage.transition',
      at: '2026-06-15T09:13:10Z',
      detail: { from: 'in_tdd_test', to: 'in_dev', reason: 'Tests designed' },
    },
    {
      id: 'au-009',
      proposalId: 'P-20260615-001',
      actor: 'dev',
      action: 'handoff.emit',
      at: '2026-06-15T09:13:25Z',
      detail: { to: 'qa', reason: 'Implementation complete' },
    },
    {
      id: 'au-010',
      proposalId: 'P-20260615-001',
      actor: 'qa',
      action: 'handoff.emit',
      at: '2026-06-15T09:13:30Z',
      detail: { to: 'boss', reason: 'Acceptance checks passed' },
    },
    {
      id: 'au-011',
      proposalId: 'P-20260615-001',
      actor: 'boss',
      action: 'stage.transition',
      at: '2026-06-15T09:13:35Z',
      detail: { from: 'accepted', to: 'deployed', reason: 'Boss accepted' },
    },
    {
      id: 'au-012',
      proposalId: 'P-20260615-001',
      actor: 'boss',
      action: 'stage.transition',
      at: '2026-06-15T09:13:42Z',
      detail: { from: 'deployed', to: 'delivered', reason: 'Deployment record written' },
    },
  ],
  'PRJ-20260616-001': [
    {
      id: 'au-101',
      proposalId: 'P-20260616-001',
      actor: 'system',
      action: 'proposal.create',
      at: '2026-06-16T14:22:00Z',
      detail: { title: 'Markdown linter', status: 'research_direction_pending' },
    },
    {
      id: 'au-102',
      proposalId: 'P-20260616-001',
      actor: 'market_research',
      action: 'stage.transition',
      at: '2026-06-16T14:22:08Z',
      detail: { from: 'research_direction_pending', to: 'research', reason: 'approved' },
    },
    {
      id: 'au-103',
      proposalId: 'P-20260616-001',
      actor: 'coordinator',
      action: 'handoff.emit',
      at: '2026-06-16T14:22:30Z',
      detail: { to: 'pm', reason: 'captured' },
    },
    {
      id: 'au-104',
      proposalId: 'P-20260616-001',
      actor: 'pm',
      action: 'stage.transition',
      at: '2026-06-16T14:23:00Z',
      detail: {
        from: 'clarifying',
        to: 'prd_pending_confirmation',
        reason: 'PRD drafted (round 1)',
      },
    },
    {
      id: 'au-105',
      ...
      actor: 'pm',
      action: 'stage.transition',
      at: '2026-06-16T14:23:30Z',
      detail: {
        from: 'prd_pending_confirmation',
        to: 'clarifying',
        reason: 'Boss asked for revisions (round 2)',
      },
    },
    {
      id: 'au-106',
      ...
      actor: 'pm',
      action: 'stage.transition',
      at: '2026-06-16T14:24:00Z',
      detail: { from: 'clarifying', to: 'prd_pending_confirmation', reason: 'PRD re-drafted' },
    },
    {
      id: 'au-107',
      proposalId: 'P-20260616-001',
      actor: 'pm',
      action: 'handoff.emit',
      at: '2026-06-16T14:24:10Z',
      detail: { to: 'dev', reason: 'PRD approved' },
    },
  ],
  'PRJ-20260617-001': [
    {
      id: 'au-201',
      proposalId: 'P-20260617-001',
      actor: 'system',
      action: 'proposal.create',
      at: '2026-06-17T11:05:00Z',
      detail: { title: 'Web app for tracking daily reading' },
    },
    {
      id: 'au-202',
      proposalId: 'P-20260617-001',
      actor: 'market_research',
      action: 'stage.transition',
      at: '2026-06-17T11:05:30Z',
      detail: { from: 'research_direction_pending', to: 'research' },
    },
    {
      id: 'au-203',
      proposalId: 'P-20260617-001',
      actor: 'coordinator',
      action: 'handoff.emit',
      at: '2026-06-17T11:05:40Z',
      detail: { to: 'designer', reason: 'UI work detected' },
    },
    {
      id: 'au-204',
      proposalId: 'P-20260617-001',
      actor: 'designer',
      action: 'handoff.emit',
      at: '2026-06-17T11:06:00Z',
      detail: { to: 'pm', reason: 'UI spec drafted' },
    },
    {
      id: 'au-205',
      proposalId: 'P-20260617-001',
    ...
    },
    {
      ...
      actor: 'qa',
      action: 'handoff.emit',
      at: '2026-06-17T11:08:30Z',
      detail: { to: 'boss', reason: 'Acceptance passed' },
    },
    {
      id: 'au-208',
      proposalId: 'P-20260617-001',
      actor: 'boss',
      action: 'stage.transition',
      at: '2026-06-17T11:08:55Z',
      detail: { from: 'deployed', to: 'delivered' },
    },
  ],
  'PRJ-20260618-001': [
    {
      id: 'au-301',
      proposalId: 'P-20260618-001',
      actor: 'system',
      action: 'proposal.create',
      at: '2026-06-18T16:30:00Z',
      detail: { title: 'WebSocket chat server' },
    },
    {
      id: 'au-302',
      proposalId: 'P-20260618-001',
    ...
    },
    {
      ...
      actor: 'qa',
      action: 'qa.failure',
      at: '2026-06-18T16:35:00Z',
      detail: { reason: '2 acceptance checks failed' },
    },
    {
      id: 'au-307',
      proposalId: 'P-20260618-001',
      actor: 'qa',
      action: 'stage.transition',
      at: '2026-06-18T16:35:12Z',
      detail: {
        from: 'in_test_acceptance',
        to: 'test_failed',
        reason: 'Routing to test_failed stage',
      },
    },
  ],
};
...
async function main() {
  ...
  await fs.writeFile(path.join(demoDir, 'proposals.json'), JSON.stringify(PROPOSALS, null, 2));
